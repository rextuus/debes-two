...
class NextStateLoanConfirmed extends AbstractNextState implements NextStateInterface
{
    public const NEXT_STATE_SHORTCUT = Transaction::STATE_CONFIRMED . AbstractNextState::LOAN_POSTFIX;
